...
class EtpSession(db.Model):
    ...
    conversation_stage = db.Column(db.String(50), default='collect_need')  # collect_need, suggest_requirements, review_requirements, options, legal_norms, done
    requirements_json = db.Column(db.Text)  # JSON com lista de requisitos [{"id":"R1","text":"...","justification":"...","source":{}}]
    procurement_path = db.Column(db.String(50))  # Caminho escolhido: "compra", "locacao", "comodato", etc.
